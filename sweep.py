...
class Job:
    ...
    def __init__(self, train_args, sweep_output_dir):
        ...
        print('Command is', self.command_str)
    ...
    def launch(jobs, launcher_fn):
        ...
        job_paths = [job.output_dir for job in jobs]
        launcher_fn(commands, job_paths)
        ...
        for dataset in dataset_names:
            for algorithm in algorithms:
                for hparams_seed in range(n_hparams_from, n_hparams):
                    ...
                    train_args['sweep'] = 1
                    train_args['seed'] = utils.seed_hash(dataset, algorithm, hparams_seed, trial_seed)
...
DATASETS = [d for d in dataset.DATASETS if "Debug" not in d]
